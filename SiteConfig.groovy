...
environments {
    ...
    prod {
        ...
        url = 'http://www.coderconsortium.com' // the site URL, for instance http://example.com
...
gh_pages_url = 'git@github.com:coderconsortium/coderconsortium.github.io.git' // path to GitHub repository in format git@github.com:{username}/{repo}.git
...
disqus {
    short_name = 'coderconsortium'                 // the unique identifier assigned to a Disqus (http://disqus.com/) forum
}
...
asides {
    ...
    // GitHub repositories.
    github {
        user = 'coderconsortium'           // GitHub (https://github.com/) username
    ...
    // The latest tweets.
    tweets {
        user = 'coderconsortium'           // Twitter (https://twitter.com/) username
    ...
    google_plus {
        user = '+Coderconsortium' // Google plus (https://plus.google.com/) user id
    }
//    twitter {
//        user = 'coderconsortium'           // Twitter (https://twitter.com/) username
//    }
    facebook {
        user = 'coderconsortiumsac'           // Facebook (https://www.facebook.com/) username
    }
    instagram {
